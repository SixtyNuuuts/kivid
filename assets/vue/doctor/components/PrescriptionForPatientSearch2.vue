    ...
    <div>
        ...
        <div class="buttons">
            <vs-button
                ...
                ><i class="fe fe-user-plus"></i>Créer et sélectionner</vs-button
            >
        </div>
        <div
            v-if="$parent.$parent.patientForPrescription"
            class="selected-patient-detail"
        >
            ...
            <p>
                <span>
                    {{
                        $parent.$parent.patientForPrescription.gender &&
                        $parent.$parent.patientForPrescription.gender != "0"
                            ? "1" ===
                              $parent.$parent.patientForPrescription.gender
                                ? "M."
                                : "Mme"
                    ...
                    {{ $parent.$parent.patientForPrescription.lastname }}
                    {{ $parent.$parent.patientForPrescription.firstname }}
                </span>
            </p>
        </div>
...
export default {
    ...
    methods: {
        selectPatient(patient) {
            this.$parent.$parent.patientForPrescription = patient;
            this.search = "";
        },
        createPatient() {
            ...
            this.axios
                ...
                .then((response) => {
                    ...
                    if (response.data.patient) {
                        this.$parent.$parent.patientForPrescription =
...
.vs-dialog-content .vs-dialog__content h2,
.vs-dialog-content .vs-dialog__content .h2 {
    font-size: 1.1rem;
}
</style>
