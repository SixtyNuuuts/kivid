            ...
            .patient-details {
                ...
                .patient-prescription-btn {
                    ...
                    .vs-button {
                        ...
                        &.patient-prescription-btn-locked
                        {
                            &:not(.loading)
                            {
                                color: rgba(255, 104, 56, 0.6);
                            }
